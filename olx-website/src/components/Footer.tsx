        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">EasyBuySale</span>
            </div>
            <p className="text-gray-300 mb-4">
              India's trusted marketplace for buying and selling. Connect with millions of users 
              to find great deals or sell your items.
            </p>
